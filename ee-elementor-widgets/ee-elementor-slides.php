...
class ee_elementor_slides extends Base_Widget {
	...
	public function get_title() {
		return __( 'EE Slides', 'elementor-pro' );
	}
	...
	protected function render() {
		...
		foreach ( $settings['slides'] as $slide ) {
			...
			$slides[] = '<div class="elementor-repeater-item-' . $slide['_id'] . ' swiper-slide ' . $slide['css_classes']. '">' . $slide_html . '</div>';
			$slide_count++;
		}
			...
			<div class="elementor-slides-wrapper elementor-main-swiper swiper-container" dir="{{ direction }}" data-animation="{{ settings.content_animation }}">
				<div class="swiper-wrapper elementor-slides">
					<# jQuery.each( settings.slides, function( index, slide ) { #>
						<div class="elementor-repeater-item-{{ slide._id }} swiper-slide {{slide.css_classes}}">
							<#
							var kenClass = '';
